...
const projects = () => {
  return (
    <section id="projects" className="bg-cyan-900 flex flex-col items-center min-h-[40vh] py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-7xl mt-6">
        {/* Project 1 */}
        ...
        <div className="bg-cyan-950/70 rounded-2xl shadow-lg p-6 flex flex-col border-cyan-600 transition duration-300 transform hover:scale-105 hover:border-cyan-300">
          ...
          <div className="flex gap-4 mt-5">
            <a href="#" target="_blank" className="text-amber-50 hover:text-cyan-300 rounded-2xl text-2xl "><FaGithub /></a>
            <a href="#" target="_blank" className="text-amber-50 hover:text-cyan-300 rounded-2xl text-2xl "><IoLink /></a>
          </div>
        </div>
