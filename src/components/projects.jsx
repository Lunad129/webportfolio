...
const projects = () => {
  return (
    <section  id="projects" className="bg-blue-950 flex flex-col justify-center items-center min-h-[40vh]">
        <h1 className="font-mono text-amber-50 text-3xl text-center mb-6 font-bold mt-5">Projects</h1>
